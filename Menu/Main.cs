...
namespace StupidTemplate.Menu
{
    ...
    public class Main : MonoBehaviour
    {
        ...
        public static void Prefix()
        {
            ...
            if (CustomStumpTexts == null)
            {
                CustomStumpTexts = new GameObject("cylviatxt");
            }
            TextMeshPro textMeshPro = CustomStumpTexts.GetComponent<TextMeshPro>();
            if (textMeshPro == null)
            {
                textMeshPro = CustomStumpTexts.AddComponent<TextMeshPro>();
                textMeshPro.fontSize = 2f;
                textMeshPro.fontStyle = (FontStyles)1;
            ...
            CustomStumpTexts.transform.position = new Vector3(-66.8087f, 12.1808f, -82.5265f);
            CustomStumpTexts.transform.LookAt(Camera.main.transform);
            CustomStumpTexts.transform.Rotate(0f, 180f, 0f);
        }
        ...
        public static string[] CustomBoardTexts = new string[]  
        {
            "CYLVIA", 
            "CYLVIA",
            "----- Mod Meanings ----- \n \n M = Master \n D = Detected \n D? = Might Be Detected \n D! = Very Detected \n----- Buttons ------ \n \n RT = Right Trigger \n LT = Left Trigger \n A, X, B, Y are buttons on your controllers.", 
            "Thank you for using VISION, by visionare. \nThere are NaN mods on this menu. \n<color=red> IF YOU GET BANNED, IT IS NOT VISIONARE'S FAULT.</color> \n<color=purple> Please let us know if you got banned when using mods, and what mods you were using.</color>" 
        };
        public static GameObject CustomStumpTexts;
