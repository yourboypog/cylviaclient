    ...
    public class Buttons
    {
        ...
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            ...
            new ButtonInfo[] { // Menu Settings [2]
                ...
                new ButtonInfo { buttonText = "cbs", overlapText = "Change Button Sound: Default", method=() => Settings.ChangeButtonSound(), isTogglable = false, toolTip = "Changes the button sound of the menu."},
            },
            ...
            new ButtonInfo[] { // Movement Mods [5]
                ...
                new ButtonInfo { buttonText = "Platforms", method =() => Movement.Platforms(), toolTip = "Creates platforms underneath your hands."},
            },
